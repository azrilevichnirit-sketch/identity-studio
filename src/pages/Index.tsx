...
const Index = () => {
  ...
  return (
    <>
      ...
      <AudioManager isPlaying={!['lead', 'processing', 'summary'].includes(state.phase)} isProcessing={state.phase === 'lead' || state.phase === 'processing' || state.phase === 'summary'} softVolume={state.phase === 'summary' ? 0.1 : 0.3} />
    </>
  );
};
