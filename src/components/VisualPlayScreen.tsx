...
export function VisualPlayScreen({
  ...
  const CROSSFADE_DURATION = 300; // Must match bgCrossfadeDuration default
  useEffect(() => {
  ...
  const placedPropsElement = (
    <>
      ...
      {/* Mission 8 Tool B visitors - baked into backgrounds on both mobile and desktop */}
      ...
      {/* Mission 11 Tool A avatar + Tool B crowd - baked into backgrounds on both mobile and desktop */}
      {/* No dynamic rendering needed - all characters are pre-rendered in baked backgrounds */}
    </>
  );
