...
serve(async (req) => {
  ...
  try {
    ...
    const response = await fetch("https://api.elevenlabs.io/v1/music", {
      ...
      body: JSON.stringify({
        prompt: prompt || "Upbeat lo-fi hip hop beat with warm jazzy chords, vinyl crackle texture, head-nodding groove, funky bass, and catchy melodic hooks. Energetic but not overwhelming, perfect for a game aimed at young adults in their 20s. Think chillhop meets gaming soundtrack.",
